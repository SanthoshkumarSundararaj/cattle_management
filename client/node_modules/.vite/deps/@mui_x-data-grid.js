...
import {
  ...
  createSvgIcon,
  useId_default
} from "./chunk-YIZA2TUJ.js";
import {
  Popper_default
} from "./chunk-TRYOIBQH.js";
import {
  alpha,
  darken,
  decomposeColor,
  ...
  useRtl,
  useThemeProps
} from "./chunk-5ALXFUF5.js";
import "./chunk-PS33D6Z3.js";
import {
...
// node_modules/@mui/x-data-grid/node_modules/react-is/cjs/react-is.development.js
var require_react_is_development = __commonJS({
  "node_modules/@mui/x-data-grid/node_modules/react-is/cjs/react-is.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
...
// node_modules/@mui/x-data-grid/node_modules/react-is/index.js
var require_react_is = __commonJS({
  "node_modules/@mui/x-data-grid/node_modules/react-is/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/elementAcceptingRef/elementAcceptingRef.js
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/elementTypeAcceptingRef/elementTypeAcceptingRef.js
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/getDisplayName/getDisplayName.js
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/isMuiElement/isMuiElement.js
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/setRef/setRef.js
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/useIsFocusVisible/useIsFocusVisible.js
var React14 = __toESM(require_react());
var hadFocusVisibleRecentlyTimeout = new Timeout();

// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/usePreviousProps/usePreviousProps.js
var React15 = __toESM(require_react());

// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/getValidReactChildren/getValidReactChildren.js
var React16 = __toESM(require_react());

// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/integerPropType/integerPropType.js
...
// node_modules/@mui/x-data-grid/node_modules/@mui/x-internals/fastMemo/fastMemo.js
var React17 = __toESM(require_react());

// node_modules/@mui/x-data-grid/node_modules/@mui/x-internals/fastObjectShallowCompare/fastObjectShallowCompare.js
var is = Object.is;
...
function createUseGridApiEventHandler(registryContainer2) {
  ...
  return function useGridApiEventHandler2(apiRef, eventName, handler, options) {
    ...
    const [objectRetainedByReact] = React18.useState(new ObjectToBeRetainedByReact());
    const subscription = React18.useRef(null);
    const handlerRef = React18.useRef();
    handlerRef.current = handler;
    const cleanupTokenRef = React18.useRef(null);
...
// node_modules/@mui/x-data-grid/node_modules/@mui/x-internals/warning/warning.js
...
true ? GridEditInputCell.propTypes = {
  ...
  debounceMs: import_prop_types4.default.number,
  /**
...
function GridFilterInputValue(props) {
  ...
  const [filterValueState, setFilterValueState] = React21.useState(item.value ?? "");
  const [applying, setIsApplying] = React21.useState(false);
  const id = useId();
  const rootProps = useGridRootProps();
  const onFilterChange = React21.useCallback((event) => {
    const {
      value
    } = event.target;
...
true ? GridFilterInputValue.propTypes = {
  ...
  applyValue: import_prop_types5.default.func.isRequired,
  clearButton: import_prop_types5.default.node,
  focusElementRef: import_prop_types5.default.oneOfType([import_prop_types5.default.func, import_prop_types5.default.object]),
  /**
...
function GridFilterInputMultipleValue(props) {
  ...
  const handleChange = React22.useCallback((event, value) => {
...
true ? GridFilterInputMultipleValue.propTypes = {
  ...
  applyValue: import_prop_types6.default.func.isRequired,
  focusElementRef: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
  ...
  type: import_prop_types6.default.oneOf(["date", "datetime-local", "number", "text"])
} : void 0;
...
true ? GridMenu.propTypes = {
  ...
  position: import_prop_types7.default.oneOf(["bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
...
true ? GridActionsCell.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  api: import_prop_types8.default.object,
  /**
   * The mode of the cell.
   */
...
function GridBooleanCellRaw(props) {
  ...
  const Icon = React25.useMemo(() => value ? rootProps.slots.booleanCellTrueIcon : rootProps.slots.booleanCellFalseIcon, [rootProps.slots.booleanCellFalseIcon, rootProps.slots.booleanCellTrueIcon, value]);
...
var GridBooleanCell = React25.memo(GridBooleanCellRaw);
...
function GridEditBooleanCell(props) {
  ...
  const id = useId();
  const [valueState, setValueState] = React26.useState(value);
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  };
...
function GridFilterInputBoolean(props) {
  ...
  const [filterValueState, setFilterValueState] = React27.useState(item.value || "");
  const rootProps = useGridRootProps();
  const labelId = useId();
...
var GridCellCheckboxForwardRef = React28.forwardRef(function GridCellCheckboxRenderer(props, ref) {
  var _a;
  const {
    field,
    id,
  ...
  const checkboxElement = React28.useRef(null);
  ...
  const handleKeyDown = React28.useCallback((event) => {
    if (event.key === " ") {
      event.stopPropagation();
    }
  }, []);
...
function useGridLogger(privateApiRef, name) {
  const logger = React30.useRef(null);
  if (logger.current) {
...
var useGridNativeEventListener = (apiRef, ref, eventName, handler, options) => {
  ...
  const [added, setAdded] = React31.useState(false);
  const handlerRef = React31.useRef(handler);
  const targetElement = isFunction(ref) ? ref() : (ref == null ? void 0 : ref.current) ?? null;
  const wrapHandler = React31.useCallback((event) => {
...
var useFirstRender = (callback) => {
  const isFirstRender = React32.useRef(true);
  if (isFirstRender.current) {
    isFirstRender.current = false;
    callback();
  }
...
var useRunOnce = (condition, effect) => {
  const didRun = React33.useRef(false);
  useEnhancedEffect_default(() => {
...
var GridHeaderCheckbox = React34.forwardRef(function GridHeaderCheckbox2(props, ref) {
  var _a;
  const other = _objectWithoutPropertiesLoose(props, _excluded10);
  const [, forceUpdate] = React34.useState(false);
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  ...
  const filteredSelection = React34.useMemo(() => {
  ...
  const selectionCandidates = React34.useMemo(() => {
  ...
  const currentSelectionSize = React34.useMemo(() => filteredSelection.filter((id) => selectionCandidates[id]).length, [filteredSelection, selectionCandidates]);
  ...
  const handleKeyDown = React34.useCallback((event) => {
    if (event.key === " ") {
  ...
  const handleSelectionChange = React34.useCallback(() => {
    forceUpdate((p) => !p);
  }, []);
  React34.useEffect(() => {
...
function GridFilterInputDate(props) {
  ...
  const filterTimeout = useTimeout();
  const [filterValueState, setFilterValueState] = React36.useState(() => convertFilterItemValueToInputValue(item.value, type));
  const [applying, setIsApplying] = React36.useState(false);
  const id = useId();
  const rootProps = useGridRootProps();
  const onFilterChange = React36.useCallback((event) => {
    filterTimeout.clear();
    const value = event.target.value;
    setFilterValueState(value);
    setIsApplying(true);
...
function GridEditDateCell(props) {
  ...
  const valueTransformed = React37.useMemo(() => {
    let parsedDate;
    if (valueProp == null) {
      parsedDate = null;
  ...
  const [valueState, setValueState] = React37.useState(valueTransformed);
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  };
  const classes2 = useUtilityClasses7(ownerState);
  const parseValueToDate = React37.useCallback((value) => {
    if (value === "") {
      return null;
    }
  ...
  const handleChange = React37.useCallback(async (event) => {
...
true ? GridEditDateCell.propTypes = {
   ...
   * GridApi that let you manipulate the grid.
   */
  api: import_prop_types15.default.object.isRequired,
  /**
   * The mode of the cell.
   */
  cellMode: import_prop_types15.default.oneOf(["edit", "view"]).isRequired,
  changeReason: import_prop_types15.default.oneOf(["debouncedSetEditCellValue", "setEditCellValue"]),
  /**
   * The column of the row that the current cell belongs to.
   */
  colDef: import_prop_types15.default.object.isRequired,
  /**
   * The column field of the cell that triggered the event.
   */
   ...
   * The cell value formatted with the column valueFormatter.
   */
  formattedValue: import_prop_types15.default.any,
  /**
   * If true, the cell is the active element.
   */
  hasFocus: import_prop_types15.default.bool.isRequired,
  /**
   * The grid row id.
   */
   ...
   * If true, the cell is editable.
   */
  isEditable: import_prop_types15.default.bool,
  isProcessingProps: import_prop_types15.default.bool,
  isValidating: import_prop_types15.default.bool,
  /**
   * Callback called when the value is changed by the user.
   * @param {React.ChangeEvent<HTMLInputElement>} event The event source of the callback.
   * @param {Date | null} newValue The value that is going to be passed to `apiRef.current.setEditCellValue`.
   * @returns {Promise<void> | void} A promise to be awaited before calling `apiRef.current.setEditCellValue`
   */
  onValueChange: import_prop_types15.default.func,
  /**
   * The row model of the row that the current cell belongs to.
   */
  row: import_prop_types15.default.any.isRequired,
  /**
   * The node of the row that the current cell belongs to.
   */
  rowNode: import_prop_types15.default.object.isRequired,
  /**
   * the tabIndex value.
   */
...
function GridEditSingleSelectCell(props) {
  ...
  const [open, setOpen] = React38.useState(initialOpen);
  const baseSelectProps = ((_a = rootProps.slotProps) == null ? void 0 : _a.baseSelect) || {};
  const isSelectNative = baseSelectProps.native ?? false;
...
true ? GridEditSingleSelectCell.propTypes = {
   ...
   * GridApi that let you manipulate the grid.
   */
  api: import_prop_types16.default.object.isRequired,
  /**
   * The mode of the cell.
   */
  cellMode: import_prop_types16.default.oneOf(["edit", "view"]).isRequired,
  changeReason: import_prop_types16.default.oneOf(["debouncedSetEditCellValue", "setEditCellValue"]),
  /**
   * The column of the row that the current cell belongs to.
   */
  colDef: import_prop_types16.default.object.isRequired,
  /**
   * The column field of the cell that triggered the event.
   */
   ...
   * The cell value formatted with the column valueFormatter.
   */
  formattedValue: import_prop_types16.default.any,
  /**
   * If true, the cell is the active element.
   */
  hasFocus: import_prop_types16.default.bool.isRequired,
  /**
   * The grid row id.
   */
   ...
   */
  initialOpen: import_prop_types16.default.bool,
  /**
   * If true, the cell is editable.
   */
  isEditable: import_prop_types16.default.bool,
   ...
   * @returns {Promise<void> | void} A promise to be awaited before calling `apiRef.current.setEditCellValue`
   */
  onValueChange: import_prop_types16.default.func,
  /**
   * The row model of the row that the current cell belongs to.
   */
  row: import_prop_types16.default.any.isRequired,
  /**
   * The node of the row that the current cell belongs to.
   */
  rowNode: import_prop_types16.default.object.isRequired,
  /**
   * the tabIndex value.
   */
  tabIndex: import_prop_types16.default.oneOf([-1, 0]).isRequired,
  /**
   * The cell value.
   * If the column has `valueGetter`, use `params.row` to directly access the fields.
   */
...
function GridFilterInputSingleSelect(props) {
  ...
  const currentValueOptions = React39.useMemo(() => {
    return getValueOptions(resolvedColumn);
  }, [resolvedColumn]);
  const onFilterChange = React39.useCallback((event) => {
...
true ? GridFilterInputSingleSelect.propTypes = {
  ...
  apiRef: import_prop_types17.default.shape({
    current: import_prop_types17.default.object.isRequired
  }).isRequired,
  applyValue: import_prop_types17.default.func.isRequired,
  clearButton: import_prop_types17.default.node,
  focusElementRef: import_prop_types17.default.oneOfType([import_prop_types17.default.func, import_prop_types17.default.object]),
  /**
   * It is `true` if the filter either has a value or an operator with no value
   * required is selected (for example `isEmpty`)
   */
  isFilterActive: import_prop_types17.default.bool,
  item: import_prop_types17.default.shape({
    ...
    operator: import_prop_types17.default.string.isRequired,
...
function GridFilterInputMultipleSingleSelect(props) {
  ...
  const getOptionValue = resolvedColumn == null ? void 0 : resolvedColumn.getOptionValue;
  const getOptionLabel = resolvedColumn == null ? void 0 : resolvedColumn.getOptionLabel;
  const isOptionEqualToValue = React40.useCallback((option, value) => getOptionValue(option) === getOptionValue(value), [getOptionValue]);
  const resolvedValueOptions = React40.useMemo(() => {
    return getValueOptions(resolvedColumn) || [];
  }, [resolvedColumn]);
  const filteredValues = React40.useMemo(() => {
  ...
  const handleChange = React40.useCallback((event, value) => {
    applyValue(_extends({}, item, {
...
true ? GridFilterInputMultipleSingleSelect.propTypes = {
  ...
  apiRef: import_prop_types18.default.shape({
    current: import_prop_types18.default.object.isRequired
  }).isRequired,
  applyValue: import_prop_types18.default.func.isRequired,
  focusElementRef: import_prop_types18.default.oneOfType([import_prop_types18.default.func, import_prop_types18.default.object]),
  item: import_prop_types18.default.shape({
    ...
    operator: import_prop_types18.default.string.isRequired,
    value: import_prop_types18.default.any
  }).isRequired,
  type: import_prop_types18.default.oneOf(["singleSelect"])
} : void 0;
...
function GridScrollAreaRaw(props) {
  ...
  const scrollPosition = React41.useRef({
    left: 0,
    top: 0
  });
  ...
  const [canScrollMore, setCanScrollMore] = React41.useState(getCanScrollMore);
  const rootProps = useGridRootProps();
...
// node_modules/@mui/x-data-grid/node_modules/@mui/x-internals/useResizeObserver/useResizeObserver.js
var React42 = __toESM(require_react());
var isDevEnvironment = true;
var noop2 = () => {
};
function useResizeObserver(ref, fn, enabled) {
  const fnRef = React42.useRef(null);
  fnRef.current = fn;
  useEnhancedEffect_default(() => {
...
var GridPrivateApiContext = React43.createContext(void 0);
if (true) {
  GridPrivateApiContext.displayName = "GridPrivateApiContext";
}
function useGridPrivateApiContext() {
  const privateApiRef = React43.useContext(GridPrivateApiContext);
...
var useGridVirtualScroller = () => {
  ...
  const [panels, setPanels] = React46.useState(EMPTY_DETAIL_PANELS);
  const isRtl = useRtl();
  ...
  const scrollbarVerticalRef = React46.useRef(null);
  const scrollbarHorizontalRef = React46.useRef(null);
  const contentHeight = dimensions.contentSize.height;
  const columnsTotalWidth = dimensions.columnsTotalWidth;
  const hasColSpan = useGridSelector(apiRef, gridHasColSpanSelector);
  useResizeObserver(mainRef, () => apiRef.current.resize());
  const scrollPosition = React46.useRef(EMPTY_SCROLL_POSITION);
  const previousContextScrollPosition = React46.useRef(EMPTY_SCROLL_POSITION);
  const previousRowContext = React46.useRef(EMPTY_RENDER_CONTEXT);
  const renderContext = useGridSelector(apiRef, gridRenderContextSelector);
  const scrollTimeout = useTimeout();
  const frozenContext = React46.useRef(void 0);
  ...
  const focusedCell = {
    rowIndex: React46.useMemo(() => cellFocus ? currentPage.rows.findIndex((row) => row.id === cellFocus.id) : -1, [cellFocus, currentPage.rows]),
    columnIndex: React46.useMemo(() => cellFocus ? visibleColumns.findIndex((column) => column.field === cellFocus.field) : -1, [cellFocus, visibleColumns])
  };
  const updateRenderContext = React46.useCallback((nextRenderContext) => {
...
true ? GridOverlays.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  loadingOverlayVariant: import_prop_types19.default.oneOf(["circular-progress", "linear-progress", "skeleton"]),
  overlayType: import_prop_types19.default.oneOf(["loadingOverlay", "noResultsOverlay", "noRowsOverlay"])
} : void 0;
...
var GridConfigurationContext = React49.createContext(void 0);
if (true) {
...
var useGridConfiguration = () => {
  const configuration2 = React50.useContext(GridConfigurationContext);
...
var GridCell = React61.forwardRef(function GridCell2(props, ref) {
  var _a;
  const {
    column,
    rowId,
...
true ? GridCell.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  align: import_prop_types20.default.oneOf(["center", "left", "right"]).isRequired,
  ...
  disableDragEvents: import_prop_types20.default.bool,
  editCellState: import_prop_types20.default.shape({
  ...
  gridHasFiller: import_prop_types20.default.bool.isRequired,
  isNotVisible: import_prop_types20.default.bool.isRequired,
  onClick: import_prop_types20.default.func,
  onDoubleClick: import_prop_types20.default.func,
  onDragEnter: import_prop_types20.default.func,
  onDragOver: import_prop_types20.default.func,
  ...
  pinnedOffset: import_prop_types20.default.number.isRequired,
  pinnedPosition: import_prop_types20.default.oneOf([0, 1, 2, 3]).isRequired,
  rowId: import_prop_types20.default.oneOfType([import_prop_types20.default.number, import_prop_types20.default.string]).isRequired,
  sectionIndex: import_prop_types20.default.number.isRequired,
  sectionLength: import_prop_types20.default.number.isRequired,
...
true ? GridActionsCellItem.propTypes = {
  ...
  showInMenu: import_prop_types21.default.bool
} : void 0;
...
function GridSkeletonCell(props) {
  ...
  const skeletonProps = React63.useMemo(() => {
...
true ? GridSkeletonCell.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  align: import_prop_types22.default.string,
  /**
   * If `true`, the cell will not display the skeleton but still reserve the cell space.
   * @default false
   */
  empty: import_prop_types22.default.bool,
  field: import_prop_types22.default.string,
  height: import_prop_types22.default.oneOfType([import_prop_types22.default.oneOf(["auto"]), import_prop_types22.default.number]),
  type: import_prop_types22.default.oneOf(["actions", "boolean", "custom", "date", "dateTime", "number", "singleSelect", "string"]),
  width: import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string])
} : void 0;
...
var GridRoot = React64.forwardRef(function GridRoot2(props, ref) {
  const rootProps = useGridRootProps();
  const {
    className
...
var ColumnHeaderMenuIcon = React68.memo((props) => {
  var _a, _b;
  const {
    colDef,
    open,
  ...
  const handleMenuIconClick = React68.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
...
true ? GridColumnHeaderMenu.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  columnMenuButtonId: import_prop_types27.default.string,
  columnMenuId: import_prop_types27.default.string,
  ContentComponent: import_prop_types27.default.elementType.isRequired,
  contentComponentProps: import_prop_types27.default.any,
...
var ColumnHeaderInnerTitle = React70.forwardRef(function ColumnHeaderInnerTitle2(props, ref) {
  const {
    className
...
function GridColumnHeaderTitle(props) {
  ...
  const rootProps = useGridRootProps();
  const titleRef = React70.useRef(null);
  const [tooltip, setTooltip] = React70.useState("");
  const handleMouseOver = React70.useCallback(() => {
...
true ? GridColumnHeaderTitle.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  columnWidth: import_prop_types28.default.number.isRequired,
  description: import_prop_types28.default.node,
...
function GridColumnHeaderSeparatorRaw(props) {
  ...
  const stopClick = React71.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
  }, []);
  return (
...
var GridColumnHeaderSeparator = React71.memo(GridColumnHeaderSeparatorRaw);
true ? GridColumnHeaderSeparatorRaw.propTypes = {
  ...
  resizable: import_prop_types29.default.bool.isRequired,
  resizing: import_prop_types29.default.bool.isRequired,
  side: import_prop_types29.default.oneOf(["left", "right"])
} : void 0;
...
var GridGenericColumnHeaderItem = React72.forwardRef(function GridGenericColumnHeaderItem2(props, ref) {
  const {
    classes: classes2,
    colIndex,
    height,
  ...
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React72.useRef(null);
...
function GridColumnHeaderItem(props) {
  ...
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React73.useRef(null);
  const columnMenuId = useId();
  const columnMenuButtonId = useId();
  const iconButtonRef = React73.useRef(null);
  const [showColumnMenuIcon, setShowColumnMenuIcon] = React73.useState(columnMenuOpen);
  const isDraggable = React73.useMemo(() => !rootProps.disableColumnReorder && !disableReorder && !colDef.disableReorder, [rootProps.disableColumnReorder, disableReorder, colDef.disableReorder]);
  let headerComponent;
  ...
  const publish = React73.useCallback((eventName) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    apiRef.current.publishEvent(eventName, apiRef.current.getColumnHeaderParams(colDef.field), event);
  }, [apiRef, colDef.field]);
  const mouseEventsHandlers = React73.useMemo(() => ({
  ...
  const draggableEventHandlers = React73.useMemo(() => isDraggable ? {
    onDragStart: publish("columnHeaderDragStart"),
    onDragEnter: publish("columnHeaderDragEnter"),
    onDragOver: publish("columnHeaderDragOver"),
    onDragEnd: publish("columnHeaderDragEnd")
  } : {}, [isDraggable, publish]);
  const columnHeaderSeparatorProps = React73.useMemo(() => ({
  ...
  const handleExited = React73.useCallback(() => {
  ...
  const columnTitleIconButtons = (0, import_jsx_runtime42.jsxs)(React73.Fragment, {
...
true ? GridColumnHeaderItem.propTypes = {
  ...
  colIndex: import_prop_types30.default.number.isRequired,
  columnMenuOpen: import_prop_types30.default.bool.isRequired,
  disableReorder: import_prop_types30.default.bool,
  filterItemsCounter: import_prop_types30.default.number,
  gridHasFiller: import_prop_types30.default.bool.isRequired,
  hasFocus: import_prop_types30.default.bool,
  headerHeight: import_prop_types30.default.number.isRequired,
  indexInSection: import_prop_types30.default.number.isRequired,
  isDragging: import_prop_types30.default.bool.isRequired,
  isLast: import_prop_types30.default.bool.isRequired,
  isLastUnpinned: import_prop_types30.default.bool.isRequired,
  isResizing: import_prop_types30.default.bool.isRequired,
  isSiblingFocused: import_prop_types30.default.bool.isRequired,
  pinnedPosition: import_prop_types30.default.oneOf(["left", "right"]),
  sectionLength: import_prop_types30.default.number.isRequired,
  separatorSide: import_prop_types30.default.oneOf(["left", "right"]),
  sortDirection: import_prop_types30.default.oneOf(["asc", "desc"]),
  sortIndex: import_prop_types30.default.number,
...
var GridIconButtonContainer = React74.forwardRef(function GridIconButtonContainer2(props, ref) {
  const {
    className
...
var GridColumnHeaderSortIcon = React75.memo(GridColumnHeaderSortIconRaw);
true ? GridColumnHeaderSortIconRaw.propTypes = {
  ...
  sortingOrder: import_prop_types31.default.arrayOf(import_prop_types31.default.oneOf(["asc", "desc"])).isRequired
} : void 0;
...
true ? GridColumnHeaderFilterIconButton.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  counter: import_prop_types32.default.number,
...
true ? GridColumnMenuContainer.propTypes = {
  ...
  hideMenu: import_prop_types33.default.func.isRequired,
  id: import_prop_types33.default.string,
  labelledby: import_prop_types33.default.string,
...
var useGridColumnMenuSlots = (props) => {
  ...
  const processedComponents = React79.useMemo(() => _extends({}, defaultSlots2, slots), [defaultSlots2, slots]);
...
function GridColumnMenuColumnsItem(props) {
  return (0, import_jsx_runtime50.jsxs)(React82.Fragment, {
...
function GridColumnMenuSortItem(props) {
  ...
  return (0, import_jsx_runtime52.jsxs)(React84.Fragment, {
...
var GridGenericColumnMenu = React85.forwardRef(function GridGenericColumnMenu2(props, ref) {
  const {
    defaultSlots: defaultSlots2,
    defaultSlotProps,
    slots,
...
true ? GridColumnMenu.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  colDef: import_prop_types39.default.object.isRequired,
  hideMenu: import_prop_types39.default.func.isRequired,
  id: import_prop_types39.default.string,
  labelledby: import_prop_types39.default.string,
...
function GridColumnsManagement(props) {
  ...
  return (0, import_jsx_runtime55.jsxs)(React87.Fragment, {
...
true ? GridColumnsManagement.propTypes = {
   ...
   * @default true
   */
  autoFocusSearchField: import_prop_types41.default.bool,
  /**
   * If `true`, the `Reset` button will not be disabled
   * @default false
   */
  disableResetButton: import_prop_types41.default.bool,
  /**
   * If `true`, the `Show/Hide all` toggle checkbox will not be displayed.
   * @default false
   */
  disableShowHideToggle: import_prop_types41.default.bool,
  /**
   ...
   */
  getTogglableColumns: import_prop_types41.default.func,
  searchPredicate: import_prop_types41.default.func,
  sort: import_prop_types41.default.oneOf(["asc", "desc"]),
  /**
   ...
   * @default 'all'
   */
  toggleAllMode: import_prop_types41.default.oneOf(["all", "filteredOnly"])
} : void 0;
...
true ? GridPanel.propTypes = {
  ...
  ownerState: import_prop_types43.default.object
} : void 0;
...
true ? GridFilterForm.propTypes = {
   ...
   */
  applyFilterChanges: import_prop_types47.default.func.isRequired,
  /**
   * Callback called when the logic operator is changed.
   * @param {GridLogicOperator} operator The new logic operator.
   */
  applyMultiFilterOperatorChanges: import_prop_types47.default.func.isRequired,
  /**
   * @ignore - do not document.
   */
   ...
   * @default {}
   */
  columnInputProps: import_prop_types47.default.any,
  /**
   * Changes how the options in the columns selector should be ordered.
   * If not specified, the order is derived from the `columns` prop.
   */
  columnsSort: import_prop_types47.default.oneOf(["asc", "desc"]),
  /**
   * Callback called when the delete button is clicked.
   * @param {GridFilterItem} item The deleted [[GridFilterItem]].
   */
  deleteFilter: import_prop_types47.default.func.isRequired,
  /**
   * Props passed to the delete icon.
   * @default {}
   */
  deleteIconProps: import_prop_types47.default.any,
  /**
   * If `true`, disables the logic operator field but still renders it.
   */
  disableMultiFilterOperator: import_prop_types47.default.bool,
  /**
   * Allows to filter the columns displayed in the filter form.
   * @param {FilterColumnsArgs} args The columns of the grid and name of field.
   * @returns {GridColDef['field'][]} The filtered fields array.
   */
  filterColumns: import_prop_types47.default.func,
  /**
   * A ref allowing to set imperative focus.
   ...
   */
  hasMultipleFilters: import_prop_types47.default.bool.isRequired,
  /**
   ...
   * @default {}
   */
  logicOperatorInputProps: import_prop_types47.default.any,
  /**
   * Sets the available logic operators.
   * @default [GridLogicOperator.And, GridLogicOperator.Or]
   */
  logicOperators: import_prop_types47.default.arrayOf(import_prop_types47.default.oneOf(["and", "or"]).isRequired),
  /**
   * Props passed to the operator input component.
   * @default {}
   */
  operatorInputProps: import_prop_types47.default.any,
  /**
   ...
   */
  showMultiFilterOperators: import_prop_types47.default.bool,
  /**
   * Props passed to the value input component.
   * @default {}
   */
  valueInputProps: import_prop_types47.default.any
} : void 0;
...
true ? GridFilterPanel.propTypes = {
   ...
   * If not specified, the order is derived from the `columns` prop.
   */
  columnsSort: import_prop_types48.default.oneOf(["asc", "desc"]),
  /**
   * If `true`, the `Add filter` button will not be displayed.
   * @default false
   */
  disableAddFilterButton: import_prop_types48.default.bool,
  /**
   * If `true`, the `Remove all` button will be disabled
   * @default false
   */
  disableRemoveAllButton: import_prop_types48.default.bool,
  /**
   * Props passed to each filter form.
   */
  filterFormProps: import_prop_types48.default.shape({
    columnInputProps: import_prop_types48.default.any,
    columnsSort: import_prop_types48.default.oneOf(["asc", "desc"]),
    deleteIconProps: import_prop_types48.default.any,
    filterColumns: import_prop_types48.default.func,
    logicOperatorInputProps: import_prop_types48.default.any,
    operatorInputProps: import_prop_types48.default.any,
    valueInputProps: import_prop_types48.default.any
  }),
  /**
   ...
   */
  getColumnForNewFilter: import_prop_types48.default.func,
  /**
   * Sets the available logic operators.
   * @default [GridLogicOperator.And, GridLogicOperator.Or]
   */
  logicOperators: import_prop_types48.default.arrayOf(import_prop_types48.default.oneOf(["and", "or"]).isRequired),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var GridToolbarDensitySelector = React96.forwardRef(function GridToolbarDensitySelector2(props, ref) {
  ...
  return (0, import_jsx_runtime64.jsxs)(React96.Fragment, {
...
var GridToolbarExportContainer = React98.forwardRef(function GridToolbarExportContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime66.jsxs)(React98.Fragment, {
...
true ? GridToolbarExport.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  csvOptions: import_prop_types53.default.object,
  printOptions: import_prop_types53.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
...
true ? GridToolbarQuickFilter.propTypes = {
   ...
   * @default 150
   */
  debounceMs: import_prop_types54.default.number,
  /**
   ...
   */
  quickFilterFormatter: import_prop_types54.default.func,
  /**
   ...
   *   .filter((word) => word !== '')
   */
  quickFilterParser: import_prop_types54.default.func
} : void 0;
...
true ? GridToolbar.propTypes = {
   ...
   */
  quickFilterProps: import_prop_types55.default.object,
  /**
   * Show the quick filter component.
   * @default false
   */
  showQuickFilter: import_prop_types55.default.bool,
...
true ? GridSelectedRowCount.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  selectedRowCount: import_prop_types56.default.number.isRequired,
...
function GridHeader() {
  var _a;
  const rootProps = useGridRootProps();
  return (0, import_jsx_runtime73.jsxs)(React105.Fragment, {
...
var GridSkeletonLoadingOverlay = React107.forwardRef(function GridSkeletonLoadingOverlay2(props, forwardedRef) {
  const rootProps = useGridRootProps();
  const {
    slots
  } = rootProps;
  ...
  const inViewportCount = React107.useMemo(() => positions.filter((value) => value <= totalWidth).length, [totalWidth, positions]);
  const allVisibleColumns = useGridSelector(apiRef, gridVisibleColumnDefinitionsSelector);
  const columns = React107.useMemo(() => allVisibleColumns.slice(0, inViewportCount), [allVisibleColumns, inViewportCount]);
  const pinnedColumns = useGridSelector(apiRef, gridVisiblePinnedColumnDefinitionsSelector);
  const getPinnedStyle = React107.useCallback((computedWidth, index, position) => {
    const pinnedOffset = getPinnedCellOffset(position, computedWidth, index, positions, dimensions);
    return {
      [position]: pinnedOffset
    };
  }, [dimensions, positions]);
  const getPinnedPosition = React107.useCallback((field) => {
  ...
  const children = React107.useMemo(() => {
    const array = [];
...
var GridLoadingOverlay = React108.forwardRef(function GridLoadingOverlay2(props, ref) {
  const {
...
true ? GridLoadingOverlay.propTypes = {
   ...
   */
  noRowsVariant: import_prop_types58.default.oneOf(["circular-progress", "linear-progress", "skeleton"]),
   ...
   * @default 'circular-progress'
   */
  variant: import_prop_types58.default.oneOf(["circular-progress", "linear-progress", "skeleton"])
} : void 0;
...
var GridNoRowsOverlay = React109.forwardRef(function GridNoRowsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var GridPagination = React110.forwardRef(function GridPagination2(props, ref) {
  var _a;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  ...
  const computedProps = React110.useMemo(() => {
  ...
  const lastPage = React110.useMemo(() => Math.max(0, pageCount - 1), [pageCount]);
  const computedPage = React110.useMemo(() => {
    if (rowCount === -1) {
      return paginationModel.page;
    }
    return paginationModel.page <= lastPage ? paginationModel.page : lastPage;
  }, [lastPage, paginationModel.page, rowCount]);
  const handlePageSizeChange = React110.useCallback((event) => {
    const pageSize = Number(event.target.value);
    apiRef.current.setPageSize(pageSize);
  }, [apiRef]);
  const handlePageChange = React110.useCallback((_, page) => {
  ...
  if (true) {
    const warnedOnceMissingInPageSizeOptions = React110.useRef(false);
...
var GridRowCount = React111.forwardRef(function GridRowCount2(props, ref) {
  const {
    className,
    rowCount,
    visibleRowCount
...
true ? GridRowCount.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  rowCount: import_prop_types61.default.number.isRequired,
  ...
  visibleRowCount: import_prop_types61.default.number.isRequired
} : void 0;
...
var GridRow = React112.forwardRef(function GridRow2(props, refProp) {
  var _a;
  const {
    selected,
    rowId,
  ...
  const publish = React112.useCallback((eventName, propHandler) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    if (!apiRef.current.getRow(rowId)) {
  ...
  const publishClick = React112.useCallback((event) => {
...
true ? GridRow.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  dimensions: import_prop_types62.default.shape({
    bottomContainerHeight: import_prop_types62.default.number.isRequired,
    columnsTotalWidth: import_prop_types62.default.number.isRequired,
    contentSize: import_prop_types62.default.shape({
      height: import_prop_types62.default.number.isRequired,
      width: import_prop_types62.default.number.isRequired
    }).isRequired,
    hasScrollX: import_prop_types62.default.bool.isRequired,
    hasScrollY: import_prop_types62.default.bool.isRequired,
    headerFilterHeight: import_prop_types62.default.number.isRequired,
    headerHeight: import_prop_types62.default.number.isRequired,
    headersTotalHeight: import_prop_types62.default.number.isRequired,
    isReady: import_prop_types62.default.bool.isRequired,
    leftPinnedWidth: import_prop_types62.default.number.isRequired,
    minimumSize: import_prop_types62.default.shape({
      height: import_prop_types62.default.number.isRequired,
      width: import_prop_types62.default.number.isRequired
    }).isRequired,
    rightPinnedWidth: import_prop_types62.default.number.isRequired,
    root: import_prop_types62.default.shape({
      height: import_prop_types62.default.number.isRequired,
      width: import_prop_types62.default.number.isRequired
    }).isRequired,
    rowHeight: import_prop_types62.default.number.isRequired,
    rowWidth: import_prop_types62.default.number.isRequired,
    scrollbarSize: import_prop_types62.default.number.isRequired,
    topContainerHeight: import_prop_types62.default.number.isRequired,
    viewportInnerSize: import_prop_types62.default.shape({
      height: import_prop_types62.default.number.isRequired,
      width: import_prop_types62.default.number.isRequired
    }).isRequired,
    viewportOuterSize: import_prop_types62.default.shape({
      height: import_prop_types62.default.number.isRequired,
      width: import_prop_types62.default.number.isRequired
    }).isRequired
  }).isRequired,
   ...
   */
  focusedColumnIndex: import_prop_types62.default.number,
  /**
   * Index of the row in the whole sorted and filtered dataset.
   * If some rows above have expanded children, this index also take those children into account.
   */
  index: import_prop_types62.default.number.isRequired,
  isFirstVisible: import_prop_types62.default.bool.isRequired,
  isLastVisible: import_prop_types62.default.bool.isRequired,
  isNotVisible: import_prop_types62.default.bool.isRequired,
  offsetLeft: import_prop_types62.default.number.isRequired,
  offsetTop: import_prop_types62.default.number,
  onClick: import_prop_types62.default.func,
  onDoubleClick: import_prop_types62.default.func,
  onMouseEnter: import_prop_types62.default.func,
  onMouseLeave: import_prop_types62.default.func,
  pinnedColumns: import_prop_types62.default.object.isRequired,
  renderContext: import_prop_types62.default.shape({
    firstColumnIndex: import_prop_types62.default.number.isRequired,
    firstRowIndex: import_prop_types62.default.number.isRequired,
    lastColumnIndex: import_prop_types62.default.number.isRequired,
    lastRowIndex: import_prop_types62.default.number.isRequired
  }).isRequired,
  row: import_prop_types62.default.object.isRequired,
  rowHeight: import_prop_types62.default.oneOfType([import_prop_types62.default.oneOf(["auto"]), import_prop_types62.default.number]).isRequired,
  rowId: import_prop_types62.default.oneOfType([import_prop_types62.default.number, import_prop_types62.default.string]).isRequired,
  selected: import_prop_types62.default.bool.isRequired,
  showBottomBorder: import_prop_types62.default.bool.isRequired,
  /**
   * Determines which cell should be tabbable by having tabIndex=0.
   * If `null`, no cell in this row is in the tab sequence.
   */
  tabbableCell: import_prop_types62.default.string,
  visibleColumns: import_prop_types62.default.arrayOf(import_prop_types62.default.object).isRequired
} : void 0;
...
var useGridRowAriaAttributes = () => {
  ...
  const headerGroupingMaxDepth = useGridSelector(apiRef, gridColumnGroupsHeaderMaxDepthSelector);
  return React113.useCallback((rowNode, index) => {
...
function GridContextProvider({
  ...
  const apiRef = React114.useRef(privateApiRef.current.getPublicApi());
...
var useGridRefs = (apiRef) => {
  const rootElementRef = React115.useRef(null);
  const mainElementRef = React115.useRef(null);
  const virtualScrollerRef = React115.useRef(null);
  const columnHeadersContainerRef = React115.useRef(null);
...
var useGridIsRtl = (apiRef) => {
  ...
  const isFirstEffect = React116.useRef(true);
  React116.useEffect(() => {
...
var useGridLoggerFactory = (apiRef, props) => {
  const getLogger = React117.useCallback((name) => {
    if (forceDebug) {
...
// node_modules/@mui/x-data-grid/node_modules/@mui/x-internals/EventManager/EventManager.js
...
function useGridApiInitialization(inputApiRef, props) {
  var _a;
  const publicApiRef = React118.useRef();
  const privateApiRef = React118.useRef();
  ...
  const publishEvent = React118.useCallback((...args) => {
  ...
  const subscribeEvent = React118.useCallback((event, handler, options) => {
  ...
  React118.useImperativeHandle(inputApiRef, () => publicApiRef.current, [publicApiRef]);
  React118.useEffect(() => {
    const api = privateApiRef.current;
    return () => {
...
var useGridLocaleText = (apiRef, props) => {
  const getLocaleText = React119.useCallback((key) => {
...
var useGridStrategyProcessing = (apiRef) => {
  ...
  const setStrategyAvailability = React124.useCallback((strategyGroup, strategyName, isAvailable) => {
...
var useGridStateInitialization = (apiRef) => {
  const controlStateMapRef = React125.useRef({});
  const [, rawForceUpdate] = React125.useState();
  const registerControlState = React125.useCallback((controlStateItem) => {
    controlStateMapRef.current[controlStateItem.stateId] = controlStateItem;
  }, []);
  const setState = React125.useCallback((state, reason) => {
    let newState;
    if (isFunction(state)) {
  ...
  const updateControlState = React125.useCallback((key, state, reason) => {
  ...
  const forceUpdate = React125.useCallback(() => rawForceUpdate(() => apiRef.current.state), [apiRef]);
...
var useGridInitializeState = (initializer, privateApiRef, props) => {
  const isInitialized = React126.useRef(false);
...
var useGridClipboard = (apiRef, props) => {
  ...
  const handleCopy = React127.useCallback((event) => {
...
var useGridColumnMenu = (apiRef) => {
  ...
  const showColumnMenu = React128.useCallback((field) => {
  ...
  const hideColumnMenu = React128.useCallback(() => {
    const columnMenuState = gridColumnMenuSelector(apiRef.current.state);
  ...
  const toggleColumnMenu = React128.useCallback((field) => {
...
function useGridColumns(apiRef, props) {
  ...
  const previousColumnsProp = React129.useRef(props.columns);
  ...
  const setGridColumnsState = React129.useCallback((columnsState) => {
    var _a2, _b2;
  ...
  const getColumn = React129.useCallback((field) => gridColumnLookupSelector(apiRef)[field], [apiRef]);
  const getAllColumns = React129.useCallback(() => gridColumnDefinitionsSelector(apiRef), [apiRef]);
  const getVisibleColumns = React129.useCallback(() => gridVisibleColumnDefinitionsSelector(apiRef), [apiRef]);
  const getColumnIndex = React129.useCallback((field, useVisibleColumns = true) => {
    const columns = useVisibleColumns ? gridVisibleColumnDefinitionsSelector(apiRef) : gridColumnDefinitionsSelector(apiRef);
    return columns.findIndex((col) => col.field === field);
  }, [apiRef]);
  const getColumnPosition = React129.useCallback((field) => {
    const index = getColumnIndex(field);
    return gridColumnPositionsSelector(apiRef)[index];
  }, [apiRef, getColumnIndex]);
  const setColumnVisibilityModel = React129.useCallback((model) => {
    var _a2, _b2;
    const currentModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const updateColumns = React129.useCallback((columns) => {
    const columnsState = createColumnsState({
      apiRef,
  ...
  const setColumnVisibility = React129.useCallback((field, isVisible) => {
    const columnVisibilityModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const getColumnIndexRelativeToVisibleColumns = React129.useCallback((field) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
    return allColumns.findIndex((col) => col === field);
  }, [apiRef]);
  const setColumnIndex = React129.useCallback((field, targetIndexPosition) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
  ...
  const setColumnWidth = React129.useCallback((field, width) => {
  ...
  const stateExportPreProcessing = React129.useCallback((prevState, context) => {
    var _a2, _b2;
  ...
  const stateRestorePreProcessing = React129.useCallback((params, context) => {
    var _a2;
  ...
  const preferencePanelPreProcessing = React129.useCallback((initialValue, value) => {
    var _a2;
  ...
  const addColumnMenuItems = React129.useCallback((columnMenuItems) => {
  ...
  const prevInnerWidth = React129.useRef(null);
  ...
  const hydrateColumns = React129.useCallback(() => {
...
var useGridCsvExport = (apiRef, props) => {
  ...
  const getDataAsCsv = React131.useCallback((options = {}) => {
  ...
  const exportDataAsCsv = React131.useCallback((options) => {
  ...
  const addExportMenuButtons = React131.useCallback((initialValue, options) => {
    var _a;
...
var useGridPaginationModel = (apiRef, props) => {
  ...
  const setPage = React132.useCallback((page) => {
  ...
  const setPageSize = React132.useCallback((pageSize) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const setPaginationModel = React132.useCallback((paginationModel) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const handleUpdateAutoPageSize = React132.useCallback(() => {
  ...
  const handleRowCountChange = React132.useCallback((newRowCount) => {
    if (newRowCount == null) {
      return;
    }
    const paginationModel = gridPaginationModelSelector(apiRef);
  ...
  React132.useEffect(handleUpdateAutoPageSize, [handleUpdateAutoPageSize]);
};
...
var useGridPrintExport = (apiRef, props) => {
  ...
  const doc = React133.useRef(null);
  const previousGridState = React133.useRef(null);
  const previousColumnVisibility = React133.useRef({});
  const previousRows = React133.useRef([]);
  const previousVirtualizationState = React133.useRef();
  React133.useEffect(() => {
    doc.current = ownerDocument(apiRef.current.rootElementRef.current);
  }, [apiRef]);
  const updateGridColumnsForPrint = React133.useCallback((fields, allColumns, includeCheckboxes) => new Promise((resolve) => {
  ...
  const updateGridRowsForPrint = React133.useCallback((getRowsToExport) => {
  ...
  const handlePrintWindowLoad = React133.useCallback((printWindow, options) => {
    var _a, _b, _c, _d;
...
`;
  ...
  const handlePrintWindowAfterPrint = React133.useCallback((printWindow) => {
    var _a, _b;
  ...
  const exportDataAsPrint = React133.useCallback(async (options) => {
  ...
  const addExportMenuButtons = React133.useCallback((initialValue, options) => {
    var _a;
...
var useGridFilter = (apiRef, props) => {
  ...
  const updateFilteredRows = React134.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const addColumnMenuItem = React134.useCallback((columnMenuItems, colDef) => {
    if (colDef == null || colDef.filterable === false || props.disableColumnFilter) {
      return columnMenuItems;
    }
    return [...columnMenuItems, "columnMenuFilterItem"];
  }, [props.disableColumnFilter]);
  const applyFilters = React134.useCallback(() => {
    updateFilteredRows();
    apiRef.current.forceUpdate();
  }, [apiRef, updateFilteredRows]);
  const upsertFilterItem = React134.useCallback((item) => {
  ...
  const upsertFilterItems = React134.useCallback((items) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const deleteFilterItem = React134.useCallback((itemToDelete) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const showFilterPanel = React134.useCallback((targetColumnField, panelId, labelId) => {
  ...
  const hideFilterPanel = React134.useCallback(() => {
    logger.debug("Hiding filter panel");
    apiRef.current.hidePreferences();
  }, [apiRef, logger]);
  const setFilterLogicOperator = React134.useCallback((logicOperator) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setQuickFilterValues = React134.useCallback((values) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setFilterModel = React134.useCallback((model, reason) => {
  ...
  const getFilterState = React134.useCallback((inputFilterModel) => {
  ...
  const stateExportPreProcessing = React134.useCallback((prevState, context) => {
    var _a2, _b2;
  ...
  const stateRestorePreProcessing = React134.useCallback((params, context) => {
    var _a2;
  ...
  const preferencePanelPreProcessing = React134.useCallback((initialValue, value) => {
    var _a2;
  ...
  const flatFilteringMethod = React134.useCallback((params) => {
  ...
  const handleColumnsChange = React134.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React134.useCallback((methodName) => {
    if (methodName === "filtering") {
      apiRef.current.unstable_applyFilters();
    }
  }, [apiRef]);
  const updateVisibleRowsLookupState = React134.useCallback(() => {
    apiRef.current.setState((state) => {
      return _extends({}, state, {
...
var useGridFocus = (apiRef, props) => {
  ...
  const lastClickedCell = React135.useRef(null);
  const publishCellFocusOut = React135.useCallback((cell, event) => {
    if (cell) {
  ...
  const setCellFocus = React135.useCallback((id, field) => {
    const focusedCell = gridFocusCellSelector(apiRef);
  ...
  const setColumnHeaderFocus = React135.useCallback((field, event = {}) => {
  ...
  const setColumnHeaderFilterFocus = React135.useCallback((field, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    publishCellFocusOut(cell, event);
    apiRef.current.setState((state) => {
  ...
  const setColumnGroupHeaderFocus = React135.useCallback((field, depth, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    if (cell) {
      apiRef.current.publishEvent("cellFocusOut", apiRef.current.getCellParams(cell.id, cell.field), event);
    }
  ...
  const getColumnGroupHeaderFocus = React135.useCallback(() => gridFocusColumnGroupHeaderSelector(apiRef), [apiRef]);
  const moveFocusToRelativeCell = React135.useCallback((id, field, direction) => {
  ...
  const handleCellDoubleClick = React135.useCallback(({
    id,
    field
  }) => {
    apiRef.current.setCellFocus(id, field);
  }, [apiRef]);
  const handleCellKeyDown = React135.useCallback((params, event) => {
    if (event.key === "Enter" || event.key === "Tab" || event.key === "Shift" || isNavigationKey(event.key)) {
      return;
    }
    apiRef.current.setCellFocus(params.id, params.field);
  }, [apiRef]);
  const handleColumnHeaderFocus = React135.useCallback(({
    field
  }, event) => {
  ...
  const handleColumnGroupHeaderFocus = React135.useCallback(({
    fields,
    depth
  }, event) => {
    if (event.target !== event.currentTarget) {
  ...
  const handleBlur = React135.useCallback((_, event) => {
    var _a, _b;
  ...
  const handleCellMouseDown = React135.useCallback((params) => {
    lastClickedCell.current = params;
  }, []);
  const handleDocumentClick = React135.useCallback((event) => {
  ...
  const handleCellModeChange = React135.useCallback((params) => {
  ...
  const handleRowSet = React135.useCallback(() => {
    const cell = gridFocusCellSelector(apiRef);
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const isRtl = useRtl();
  const currentPageRows = React136.useMemo(() => enrichPageRowsWithPinnedRows(apiRef, initialCurrentPageRows), [apiRef, initialCurrentPageRows]);
  const headerFilteringEnabled = props.signature !== "DataGrid" && props.headerFilters;
  const goToCell = React136.useCallback((colIndex, rowId, closestColumnToUse = "left") => {
  ...
  const goToHeader = React136.useCallback((colIndex, event) => {
  ...
  const goToHeaderFilter = React136.useCallback((colIndex, event) => {
  ...
  const goToGroupHeader = React136.useCallback((colIndex, depth, event) => {
    logger.debug(`Navigating to header col ${colIndex}`);
    apiRef.current.scrollToIndexes({
      colIndex
    });
  ...
  const getRowIdFromIndex = React136.useCallback((rowIndex) => {
    var _a;
    return (_a = currentPageRows[rowIndex]) == null ? void 0 : _a.id;
  }, [currentPageRows]);
  const handleColumnHeaderKeyDown = React136.useCallback((params, event) => {
  ...
  const handleHeaderFilterKeyDown = React136.useCallback((params, event) => {
  ...
  const handleColumnGroupHeaderKeyDown = React136.useCallback((params, event) => {
    const focusedColumnGroup = gridFocusColumnGroupHeaderSelector(apiRef);
  ...
  const handleCellKeyDown = React136.useCallback((params, event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
  ...
  const checkIfCanStartEditing = React136.useCallback((initialValue, {
    event
  }) => {
    if (event.key === " ") {
      return false;
...
var useGridRowCount = (apiRef, props) => {
  ...
  const setRowCount = React137.useCallback((newRowCount) => {
  ...
  useGridRegisterPipeProcessor(apiRef, "exportState", stateExportPreProcessing);
  useGridRegisterPipeProcessor(apiRef, "restoreState", stateRestorePreProcessing);
  const handlePaginationModelChange = React137.useCallback((model) => {
...
var useGridPaginationMeta = (apiRef, props) => {
  ...
  const setPaginationMeta = React138.useCallback((newPaginationMeta) => {
...
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const hideTimeout = React139.useRef();
  const immediateTimeout = React139.useRef();
  const hidePreferences = React139.useCallback(() => {
  ...
  const doNotHidePanel = React139.useCallback(() => {
    immediateTimeout.current = setTimeout(() => clearTimeout(hideTimeout.current), 0);
  }, []);
  const hidePreferencesDelayed = React139.useCallback(() => {
    hideTimeout.current = setTimeout(hidePreferences, 100);
  }, [hidePreferences]);
  const showPreferences = React139.useCallback((newValue, panelId, labelId) => {
  ...
  const stateExportPreProcessing = React139.useCallback((prevState, context) => {
    var _a2;
  ...
  const stateRestorePreProcessing = React139.useCallback((params, context) => {
...
var useGridCellEditing = (apiRef, props) => {
  const [cellModesModel, setCellModesModel] = React140.useState({});
  const cellModesModelRef = React140.useRef(cellModesModel);
  const prevCellModesModel = React140.useRef({});
  const {
    processRowUpdate,
  ...
  const throwIfNotEditable = React140.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React140.useCallback((id, field, mode) => {
    if (apiRef.current.getCellMode(id, field) !== mode) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React140.useCallback((params, event) => {
  ...
  const handleCellFocusOut = React140.useCallback((params, event) => {
  ...
  const handleCellKeyDown = React140.useCallback((params, event) => {
    if (params.cellMode === GridCellModes.Edit) {
      if (event.which === 229) {
        return;
      }
  ...
  const handleCellEditStart = React140.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleCellEditStop = React140.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const getCellMode = React140.useCallback((id, field) => {
  ...
  const updateFieldInCellModesModel = React140.useCallback((id, field, newProps) => {
  ...
  const updateOrDeleteFieldState = React140.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
  ...
  const startCellEditMode = React140.useCallback((params) => {
    const {
      id,
      field
  ...
  const stopCellEditMode = React140.useCallback((params) => {
    const {
      id,
      field
  ...
  const setCellEditingEditCellValue = React140.useCallback(async (params) => {
    var _a, _b;
    const {
      id,
      field,
  ...
  const getRowWithUpdatedValuesFromCellEditing = React140.useCallback((id, field) => {
    const column = apiRef.current.getColumn(field);
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
...
var useGridRowEditing = (apiRef, props) => {
  const [rowModesModel, setRowModesModel] = React141.useState({});
  const rowModesModelRef = React141.useRef(rowModesModel);
  const prevRowModesModel = React141.useRef({});
  const focusTimeout = React141.useRef();
  const nextFocusedCell = React141.useRef(null);
  const {
    processRowUpdate,
    onProcessRowUpdateError,
  ...
  const throwIfNotEditable = React141.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React141.useCallback((id, mode) => {
    if (apiRef.current.getRowMode(id) !== mode) {
      throw new Error(`MUI X: The row with id=${id} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const hasFieldsWithErrors = React141.useCallback((rowId) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    return Object.values(editingState[rowId]).some((fieldProps) => fieldProps.error);
  }, [apiRef]);
  const handleCellDoubleClick = React141.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellFocusIn = React141.useCallback((params) => {
    nextFocusedCell.current = params;
  }, []);
  const handleCellFocusOut = React141.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleRowEditStart = React141.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleRowEditStop = React141.useCallback((params) => {
    const {
      id,
      reason,
      field
  ...
  const getRowMode = React141.useCallback((id) => {
    if (props.editMode === GridEditModes.Cell) {
  ...
  const updateRowInRowModesModel = React141.useCallback((id, newProps) => {
  ...
  const updateOrDeleteRowState = React141.useCallback((id, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
  ...
  const updateOrDeleteFieldState = React141.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
        newEditingState[id] = _extends({}, newEditingState[id], {
  ...
  const startRowEditMode = React141.useCallback((params) => {
    const {
      id
  ...
  const stopRowEditMode = React141.useCallback((params) => {
    const {
      id
  ...
  const setRowEditingEditCellValue = React141.useCallback((params) => {
    const {
      id,
      field,
      value,
  ...
  const getRowWithUpdatedValuesFromRowEditing = React141.useCallback((id) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
    if (!editingState[id]) {
      return apiRef.current.getRow(id);
...
var useGridEditing = (apiRef, props) => {
  ...
  const debounceMap = React142.useRef({});
  const {
    isCellEditable: isCellEditableProp
  } = props;
  const isCellEditable = React142.useCallback((params) => {
  ...
  const runPendingEditCellValueMutation = React142.useCallback((id, field) => {
    if (!debounceMap.current[id]) {
      return;
    }
    if (!field) {
  ...
  const setEditCellValue = React142.useCallback((params) => {
    const {
      id,
      field,
      debounceMs
  ...
  const getRowWithUpdatedValues = React142.useCallback((id, field) => {
    return props.editMode === GridEditModes.Cell ? apiRef.current.getRowWithUpdatedValuesFromCellEditing(id, field) : apiRef.current.getRowWithUpdatedValuesFromRowEditing(id);
  }, [apiRef, props.editMode]);
  const getEditCellMeta = React142.useCallback((id, field) => {
    var _a;
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
...
var useGridRows = (apiRef, props) => {
  ...
  const lastUpdateMs = React143.useRef(Date.now());
  const lastRowCount = React143.useRef(props.rowCount);
  const timeout = useTimeout();
  const getRow = React143.useCallback((id) => {
  ...
  const getRowId = React143.useCallback((row) => {
  ...
  const lookup = React143.useMemo(() => currentPage.rows.reduce((acc, {
    id
  }, index) => {
    acc[id] = index;
    return acc;
  }, {}), [currentPage.rows]);
  const throttledRowsChange = React143.useCallback(({
    cache: cache2,
    throttle: throttle2
  }) => {
    const run = () => {
  ...
  const setRows = React143.useCallback((rows) => {
  ...
  const updateRows = React143.useCallback((updates) => {
  ...
  const updateServerRows = React143.useCallback((updates, groupKeys) => {
    const nonPinnedRowsUpdates = computeRowsUpdates(apiRef, updates, props.getRowId);
    const cache2 = updateCacheWithNewRows({
      updates: nonPinnedRowsUpdates,
      getRowId: props.getRowId,
  ...
  const setLoading = React143.useCallback((loading) => {
  ...
  const getRowModels = React143.useCallback(() => {
    const dataRows = gridDataRowIdsSelector(apiRef);
    const idRowsLookup = gridRowsLookupSelector(apiRef);
    return new Map(dataRows.map((id) => [id, idRowsLookup[id] ?? {}]));
  }, [apiRef]);
  const getRowsCount = React143.useCallback(() => gridRowCountSelector(apiRef), [apiRef]);
  const getAllRowIds = React143.useCallback(() => gridDataRowIdsSelector(apiRef), [apiRef]);
  const getRowIndexRelativeToVisibleRows = React143.useCallback((id) => lookup[id], [lookup]);
  const setRowChildrenExpansion = React143.useCallback((id, isExpanded) => {
  ...
  const getRowNode = React143.useCallback((id) => gridRowTreeSelector(apiRef)[id] ?? null, [apiRef]);
  const getRowGroupChildren = React143.useCallback(({
  ...
  const setRowIndex = React143.useCallback((rowId, targetIndex) => {
  ...
  const replaceRows = React143.useCallback((firstRowToRender, newRows) => {
  ...
  const groupRows = React143.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React143.useCallback((methodName) => {
    if (methodName === "rowTreeCreation") {
      groupRows();
    }
  }, [groupRows]);
  const handleStrategyActivityChange = React143.useCallback(() => {
  ...
  const applyHydrateRowsProcessor = React143.useCallback(() => {
    apiRef.current.setState((state) => {
...
var useGridRowSelection = (apiRef, props) => {
  ...
  const propRowSelectionModel = React144.useMemo(() => {
    return getSelectionModelPropValue(props.rowSelectionModel, gridRowSelectionStateSelector(apiRef.current.state));
  }, [apiRef, props.rowSelectionModel]);
  const lastRowToggled = React144.useRef(null);
  apiRef.current.registerControlState({
  ...
  const expandMouseRowRangeSelection = React144.useCallback((id) => {
    let endId = id;
  ...
  const setRowSelectionModel = React144.useCallback((model) => {
  ...
  const isRowSelected = React144.useCallback((id) => gridRowSelectionStateSelector(apiRef.current.state).includes(id), [apiRef]);
  const isRowSelectable = React144.useCallback((id) => {
  ...
  const getSelectedRows = React144.useCallback(() => selectedGridRowsSelector(apiRef), [apiRef]);
  const selectRow = React144.useCallback((id, isSelected = true, resetSelection = false) => {
  ...
  const selectRows = React144.useCallback((ids, isSelected = true, resetSelection = false) => {
  ...
  const selectRowRange = React144.useCallback(({
    startId,
    endId
  ...
  const removeOutdatedSelection = React144.useCallback(() => {
  ...
  const handleSingleRowSelection = React144.useCallback((id, event) => {
  ...
  const handleRowClick = React144.useCallback((params, event) => {
    var _a;
  ...
  const preventSelectionOnShift = React144.useCallback((params, event) => {
    var _a;
    if (canHaveMultipleSelection && event.shiftKey) {
      (_a = window.getSelection()) == null ? void 0 : _a.removeAllRanges();
    }
  }, [canHaveMultipleSelection]);
  const handleRowSelectionCheckboxChange = React144.useCallback((params, event) => {
  ...
  const handleHeaderSelectionCheckboxChange = React144.useCallback((params) => {
...
var useGridRowSelectionPreProcessors = (apiRef, props) => {
  ...
  const updateSelectionColumn = React145.useCallback((columnsState) => {
...
var useGridSorting = (apiRef, props) => {
  ...
  const upsertSortModel = React146.useCallback((field, sortItem) => {
  ...
  const createSortItem = React146.useCallback((col, directionOverride) => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const addColumnMenuItem = React146.useCallback((columnMenuItems, colDef) => {
  ...
  const applySorting = React146.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const setSortModel = React146.useCallback((model) => {
  ...
  const sortColumn = React146.useCallback((field, direction, allowMultipleSorting) => {
    const column = apiRef.current.getColumn(field);
  ...
  const getSortModel = React146.useCallback(() => gridSortModelSelector(apiRef), [apiRef]);
  const getSortedRows = React146.useCallback(() => {
    const sortedRows = gridSortedRowEntriesSelector(apiRef);
    return sortedRows.map((row) => row.model);
  }, [apiRef]);
  const getSortedRowIds = React146.useCallback(() => gridSortedRowIdsSelector(apiRef), [apiRef]);
  const getRowIdFromRowIndex = React146.useCallback((index) => apiRef.current.getSortedRowIds()[index], [apiRef]);
  const sortApi = {
    getSortModel,
    getSortedRows,
    getSortedRowIds,
  ...
  const flatSortingMethod = React146.useCallback((params) => {
    const rowTree = gridRowTreeSelector(apiRef);
  ...
  const handleColumnHeaderClick = React146.useCallback(({
    field,
    colDef
  }, event) => {
  ...
  const handleColumnHeaderKeyDown = React146.useCallback(({
    field,
    colDef
  }, event) => {
    if (!colDef.sortable || props.disableColumnSorting) {
  ...
  const handleColumnsChange = React146.useCallback(() => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const handleStrategyProcessorChange = React146.useCallback((methodName) => {
...
var useGridScroll = (apiRef, props) => {
  ...
  const scrollToIndexes = React147.useCallback((params) => {
    var _a;
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const scroll = React147.useCallback((params) => {
  ...
  const getScrollPosition = React147.useCallback(() => {
...
// node_modules/@mui/x-data-grid/node_modules/@mui/x-internals/throttle/throttle.js
...
function useGridDimensions(apiRef, props) {
  ...
  const errorShown = React148.useRef(false);
  const rootDimensionsRef = React148.useRef(EMPTY_SIZE);
  ...
  const [savedSize, setSavedSize] = React148.useState();
  const debouncedSetSavedSize = React148.useMemo(() => throttle(setSavedSize, props.resizeThrottleMs), [props.resizeThrottleMs]);
  const previousSize = React148.useRef();
  ...
  const resize = React148.useCallback(() => {
  ...
  const getViewportPageSize = React148.useCallback(() => {
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const updateDimensions = React148.useCallback(() => {
    var _a, _b;
  ...
  const isFirstSizing = React148.useRef(true);
  const handleResize = React148.useCallback((size) => {
...
function GridColumnGroupHeader(props) {
  ...
  const rootProps = useGridRootProps();
  const headerCellRef = React149.useRef(null);
  const apiRef = useGridApiContext();
  ...
  const renderParams = React149.useMemo(() => ({
    groupId,
    headerName,
    description,
    depth,
  ...
  const publish = React149.useCallback(
    (eventName) => (event) => {
      if (isEventTargetInPortal(event)) {
        return;
      }
  ...
  const mouseEventsHandlers = React149.useMemo(() => ({
...
var useGridColumnHeaders = (props) => {
  ...
  const [dragCol, setDragCol] = React150.useState("");
  const [resizeCol, setResizeCol] = React150.useState("");
  const apiRef = useGridPrivateApiContext();
  const isRtl = useRtl();
  const rootProps = useGridRootProps();
  const dimensions = useGridSelector(apiRef, gridDimensionsSelector);
  ...
  const handleColumnResizeStart = React150.useCallback((params) => setResizeCol(params.field), []);
  const handleColumnResizeStop = React150.useCallback(() => setResizeCol(""), []);
  const handleColumnReorderStart = React150.useCallback((params) => setDragCol(params.field), []);
  const handleColumnReorderStop = React150.useCallback(() => setDragCol(""), []);
  const leftRenderContext = React150.useMemo(() => {
    return pinnedColumns.left.length ? {
      firstColumnIndex: 0,
      lastColumnIndex: pinnedColumns.left.length
    } : null;
  }, [pinnedColumns.left.length]);
  const rightRenderContext = React150.useMemo(() => {
  ...
  const getFillers = (params, children, leftOverflow, borderBottom = false) => {
    ...
    return (0, import_jsx_runtime87.jsxs)(React150.Fragment, {
...
var GridBaseColumnHeaders = React151.forwardRef(function GridColumnHeaders(props, ref) {
  const {
    className
...
var _excluded54 = ["className", "visibleColumns", "sortColumnLookup", "filterColumnLookup", "columnHeaderTabIndexState", "columnGroupHeaderTabIndexState", "columnHeaderFocus", "columnGroupHeaderFocus", "headerGroupingMaxDepth", "columnMenuState", "columnVisibility", "columnGroupsHeaderStructure", "hasOtherElementInTabSequence"];
var GridColumnHeaders2 = React152.forwardRef(function GridColumnHeaders3(props, ref) {
  const {
    visibleColumns,
    sortColumnLookup,
    filterColumnLookup,
...
true ? GridColumnHeaders2.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  columnGroupHeaderFocus: import_prop_types63.default.shape({
    depth: import_prop_types63.default.number.isRequired,
    field: import_prop_types63.default.string.isRequired
  }),
  columnGroupHeaderTabIndexState: import_prop_types63.default.shape({
    depth: import_prop_types63.default.number.isRequired,
    field: import_prop_types63.default.string.isRequired
  }),
  columnGroupsHeaderStructure: import_prop_types63.default.arrayOf(import_prop_types63.default.arrayOf(import_prop_types63.default.shape({
    columnFields: import_prop_types63.default.arrayOf(import_prop_types63.default.string).isRequired,
    groupId: import_prop_types63.default.string
  }))).isRequired,
  columnHeaderFocus: import_prop_types63.default.shape({
    field: import_prop_types63.default.string.isRequired
  }),
  columnHeaderTabIndexState: import_prop_types63.default.shape({
    field: import_prop_types63.default.string.isRequired
  }),
  columnMenuState: import_prop_types63.default.shape({
    field: import_prop_types63.default.string,
    open: import_prop_types63.default.bool.isRequired
  }).isRequired,
  columnVisibility: import_prop_types63.default.object.isRequired,
  filterColumnLookup: import_prop_types63.default.object.isRequired,
  hasOtherElementInTabSequence: import_prop_types63.default.bool.isRequired,
  headerGroupingMaxDepth: import_prop_types63.default.number.isRequired,
  sortColumnLookup: import_prop_types63.default.object.isRequired,
  visibleColumns: import_prop_types63.default.arrayOf(import_prop_types63.default.object).isRequired
} : void 0;
...
var GridNoResultsOverlay = React153.forwardRef(function GridNoResultsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var _excluded55 = ["sortingOrder"];
var GridColumnUnsortedIcon = React154.memo(function GridColumnHeaderSortIcon2(props) {
  const {
    sortingOrder
...
var _excluded56 = ["native"];
function MUISelectOption(_ref) {
  let {
    native
  } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded56);
  if (native) {
...
function useProps(allProps) {
  return React156.useMemo(() => groupForwardedProps(allProps), [allProps]);
}
...
var useDataGridProps = (inProps) => {
  ...
  const localeText = React157.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const slots = React157.useMemo(() => computeSlots({
    defaultSlots,
    slots: themedProps.slots
  }), [themedProps.slots]);
  const injectDefaultProps = React157.useMemo(() => {
    return Object.keys(DATA_GRID_PROPS_DEFAULT_VALUES).reduce((acc, key) => {
      acc[key] = themedProps[key] ?? DATA_GRID_PROPS_DEFAULT_VALUES[key];
      return acc;
    }, {});
  }, [themedProps]);
  return React157.useMemo(() => _extends({}, themedProps, injectDefaultProps, {
    localeText,
    slots
...
var useGridRowsMeta = (apiRef, props) => {
  ...
  const rowsHeightLookup = React158.useRef(/* @__PURE__ */ Object.create(null));
  const lastMeasuredRowIndex = React158.useRef(-1);
  const hasRowWithAutoHeight = React158.useRef(false);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const filterModel = useGridSelector(apiRef, gridFilterModelSelector);
  ...
  const hydrateRowsMeta = React158.useCallback(() => {
    var _a, _b;
  ...
  const getRowHeight = React158.useCallback((rowId) => {
  ...
  const setRowHeight = React158.useCallback((id, height) => {
    rowsHeightLookup.current[id].sizes.baseCenter = height;
    rowsHeightLookup.current[id].isResized = true;
    rowsHeightLookup.current[id].needsFirstMeasurement = false;
    hydrateRowsMeta();
  }, [hydrateRowsMeta]);
  const debouncedHydrateRowsMeta = React158.useMemo(() => debounce(hydrateRowsMeta, props.rowPositionsDebounceMs), [hydrateRowsMeta, props.rowPositionsDebounceMs]);
  const storeMeasuredRowHeight = React158.useCallback((id, height) => {
  ...
  const rowHasAutoHeight = React158.useCallback((id) => {
    var _a;
    return ((_a = rowsHeightLookup.current[id]) == null ? void 0 : _a.autoHeight) || false;
  }, []);
  const getLastMeasuredRowIndex = React158.useCallback(() => {
    return lastMeasuredRowIndex.current;
  }, []);
  const setLastMeasuredRowIndex = React158.useCallback((index) => {
    if (hasRowWithAutoHeight.current && index > lastMeasuredRowIndex.current) {
      lastMeasuredRowIndex.current = index;
    }
  }, []);
  const resetRowHeights = React158.useCallback(() => {
...
var useGridColumnSpanning = (apiRef) => {
  ...
  const calculateColSpan = React160.useCallback(({
    rowId,
    minFirstColumn,
    maxLastColumn,
    columns
...
// node_modules/@mui/x-data-grid/hooks/features/columnGrouping/useGridColumnGrouping.js
var _excluded57 = ["groupId", "children"];
var createGroupLookup = (columnGroupingModel) => {
  ...
  columnGroupingModel.forEach((node) => {
    ...
    const {
      groupId,
      children
    } = node, other = _objectWithoutPropertiesLoose(node, _excluded57);
    if (!groupId) {
...
var useGridColumnGrouping = (apiRef, props) => {
  const getColumnGroupPath = React161.useCallback((field) => {
    const unwrappedGroupingModel = gridColumnGroupsUnwrappedModelSelector(apiRef);
    return unwrappedGroupingModel[field] ?? [];
  }, [apiRef]);
  const getAllGroupDetails = React161.useCallback(() => {
  ...
  const handleColumnIndexChange = React161.useCallback(() => {
    const unwrappedGroupingModel = unwrapGroupingColumnModel(props.columnGroupingModel ?? []);
    apiRef.current.setState((state) => {
      var _a;
  ...
  const updateColumnGroupingState = React161.useCallback((columnGroupingModel) => {
    var _a, _b;
...
var useGridColumnResize = (apiRef, props) => {
  ...
  const initialOffsetToSeparator = React162.useRef();
  const resizeDirection = React162.useRef();
  const stopResizeEventTimeout = useTimeout();
  const touchId = React162.useRef();
  ...
  const handleResizeStart = React162.useCallback(({
    field
  }) => {
    apiRef.current.setState((state) => _extends({}, state, {
  ...
  const handleResizeStop = React162.useCallback(() => {
    apiRef.current.setState((state) => _extends({}, state, {
      columnResize: _extends({}, state.columnResize, {
        resizingColumnField: ""
      })
  ...
  const isAutosizingRef = React162.useRef(false);
  const autosizeColumns = React162.useCallback(async (userOptions) => {
    var _a;
  ...
  React162.useEffect(() => stopListening, [stopListening]);
  useOnMount(() => {
...
var DataGridRaw = React163.forwardRef(function DataGrid(inProps, ref) {
...
var DataGrid2 = React163.memo(DataGridRaw);
DataGridRaw.propTypes = {
   ...
   * @default "deselect"
   */
  indeterminateCheckboxAction: import_prop_types64.default.oneOf(["deselect", "select"]),
  /**
  ...
  pagination: import_prop_types64.default.oneOf([true]),
  /**
