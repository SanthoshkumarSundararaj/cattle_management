...
// node_modules/@mui/x-charts/node_modules/react-is/cjs/react-is.development.js
var require_react_is_development = __commonJS({
  "node_modules/@mui/x-charts/node_modules/react-is/cjs/react-is.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
...
// node_modules/@mui/x-charts/node_modules/react-is/index.js
var require_react_is = __commonJS({
  "node_modules/@mui/x-charts/node_modules/react-is/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
var InteractionContext = React12.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React12.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React12.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var axisExtremumCallback = (acc, chartType, axis, getters, isDefaultAxis, formattedSeries, getFilters) => {
  var _a;
...
var getAxisExtremum = (axis, getters, isDefaultAxis, formattedSeries, getFilters) => {
...
function usePieSeries() {
  ...
  return React15.useMemo(() => series.pie, [series.pie]);
}
...
function CartesianProvider(props) {
  ...
  const xValues = React17.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React17.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
var ChartsSurface = React21.forwardRef(function ChartsSurface2(inProps, ref) {
...
function useChartId() {
  const {
    chartId
  } = React22.useContext(DrawingContext);
  return React22.useMemo(() => chartId, [chartId]);
}
...
var ZAxisContext = React23.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React23.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function useChartGradient() {
  const {
    chartId
  } = React27.useContext(DrawingContext);
  return React27.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React33.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React33.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React37.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime12.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime12.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime12.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime12.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime12.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime12.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime12.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
...
var useEnhancedEffect = typeof window !== "undefined" ? React38.useLayoutEffect : React38.useEffect;
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React39.useRef(false);
  const rootRef = React39.useRef(null);
  const [width, setWidth] = React39.useState(0);
  const [height, setHeight] = React39.useState(0);
  const computeSize = React39.useCallback(() => {
...
function ChartsText(props) {
  ...
  const wordsByLines = React48.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime14.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index) => (0, import_jsx_runtime14.jsx)("tspan", {
      x,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React52.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React53.useState(null);
  React53.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React55.useContext(ZAxisContext);
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React57.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React57.useMemo(() => {
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(NoSsr_default, {
...
function LegendPerItem(props) {
  ...
  const isRtl = useRtl();
  const drawingArea = useDrawingArea();
  const labelStyle = React59.useMemo(
  ...
  const padding = React59.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React59.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React59.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React59.useMemo(() => {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  drawingArea: import_prop_types16.default.shape({
    bottom: import_prop_types16.default.number.isRequired,
    height: import_prop_types16.default.number.isRequired,
    left: import_prop_types16.default.number.isRequired,
    right: import_prop_types16.default.number.isRequired,
  ...
  series: import_prop_types16.default.object.isRequired,
  seriesToDisplay: import_prop_types16.default.arrayOf(import_prop_types16.default.shape({
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime26.jsxs)(React63.Fragment, {
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types18.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types18.default.oneOfType([import_prop_types18.default.number, import_prop_types18.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types18.default.oneOfType([import_prop_types18.default.func, import_prop_types18.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types18.default.oneOfType([import_prop_types18.default.func, import_prop_types18.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types18.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types18.default.number,
  /**
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default false
   */
  hideFirst: import_prop_types19.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types19.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types19.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React65.Fragment, {
...
true ? PieArc.propTypes = {
   ...
   */
  highlightScope: import_prop_types21.default.shape({
    fade: import_prop_types21.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types21.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types21.default.oneOf(["item", "none", "series"]),
    highlighted: import_prop_types21.default.oneOf(["item", "none", "series"])
  }),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React68.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
true ? PieArcPlot.propTypes = {
   ...
   */
  arcLabelRadius: import_prop_types22.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types22.default.number,
  data: import_prop_types22.default.arrayOf(import_prop_types22.default.shape({
    color: import_prop_types22.default.string.isRequired,
    endAngle: import_prop_types22.default.number.isRequired,
    formattedValue: import_prop_types22.default.string.isRequired,
    ...
    label: import_prop_types22.default.oneOfType([import_prop_types22.default.func, import_prop_types22.default.string]),
    padAngle: import_prop_types22.default.number.isRequired,
   ...
   */
  faded: import_prop_types22.default.shape({
    additionalRadius: import_prop_types22.default.number,
    arcLabelRadius: import_prop_types22.default.number,
    color: import_prop_types22.default.string,
    cornerRadius: import_prop_types22.default.number,
    innerRadius: import_prop_types22.default.number,
    outerRadius: import_prop_types22.default.number,
    paddingAngle: import_prop_types22.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types22.default.shape({
    additionalRadius: import_prop_types22.default.number,
    arcLabelRadius: import_prop_types22.default.number,
    color: import_prop_types22.default.string,
    cornerRadius: import_prop_types22.default.number,
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types23.default.string,
  ...
  isFaded: import_prop_types23.default.bool.isRequired,
  isHighlighted: import_prop_types23.default.bool.isRequired
} : void 0;
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types24.default.oneOfType([import_prop_types24.default.oneOf(["formattedValue", "label", "value"]), import_prop_types24.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types24.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types24.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types24.default.number,
  data: import_prop_types24.default.arrayOf(import_prop_types24.default.shape({
    color: import_prop_types24.default.string.isRequired,
    endAngle: import_prop_types24.default.number.isRequired,
    formattedValue: import_prop_types24.default.string.isRequired,
    ...
    index: import_prop_types24.default.number.isRequired,
    label: import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.string]),
    padAngle: import_prop_types24.default.number.isRequired,
    startAngle: import_prop_types24.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types24.default.shape({
    additionalRadius: import_prop_types24.default.number,
    arcLabelRadius: import_prop_types24.default.number,
    color: import_prop_types24.default.string,
    cornerRadius: import_prop_types24.default.number,
    innerRadius: import_prop_types24.default.number,
    outerRadius: import_prop_types24.default.number,
    paddingAngle: import_prop_types24.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types24.default.shape({
    additionalRadius: import_prop_types24.default.number,
    arcLabelRadius: import_prop_types24.default.number,
    color: import_prop_types24.default.string,
    cornerRadius: import_prop_types24.default.number,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types24.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React72.useContext(DrawingContext);
...
var PieChart = React76.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
...
true ? PieChart.propTypes = {
   ...
   * @default null
   */
  bottomAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.object, import_prop_types26.default.string]),
   ...
   * @default null
   */
  leftAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.object, import_prop_types26.default.string]),
  /**
   * The props of the legend.
   * @default { direction: 'column', position: { vertical: 'middle', horizontal: 'right' } }
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types26.default.shape({
    classes: import_prop_types26.default.object,
    direction: import_prop_types26.default.oneOf(["column", "row"]),
    hidden: import_prop_types26.default.bool,
    position: import_prop_types26.default.shape({
      horizontal: import_prop_types26.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types26.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   * @default null
   */
  rightAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.object, import_prop_types26.default.string]),
  /**
   ...
   * @default null
   */
  topAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.object, import_prop_types26.default.string]),
