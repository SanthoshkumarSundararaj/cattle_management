...
var PickersPopperPaperWrapper = React16.forwardRef((props, ref) => {
  const {
    PaperComponent,
    popperPlacement,
...
var PickersLayout = React27.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsxs)(PickersLayoutRoot, {
    ...
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime7.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime7.jsxs)(React27.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime7.jsxs)(React27.Fragment, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React29.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React29.Fragment, {
  children: [(0, import_jsx_runtime9.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime9.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var useFieldState = (params) => {
  ...
  const localizedDigits = React30.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React30.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React30.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, (date) => buildSectionsFromFormat({
    utils,
    timezone,
  ...
  const parsedSelectedSections = React30.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
...
var useFieldV7TextField = (params) => {
  ...
  const sectionListRef = React32.useRef(null);
  const handleSectionListRef = useForkRef(inSectionListRef, sectionListRef);
  const translations = usePickersTranslations();
  const utils = useUtils();
  const id = useId();
  const [focused, setFocused] = React32.useState(false);
  const interactions = React32.useMemo(() => ({
    syncSelectionToDOM: () => {
  ...
  const sectionBoundaries = React32.useMemo(() => {
    ...
    return state.sections.map((section, index) => {
      ...
      return {
        ...
        content: {
          ...
          [parseInt(React32.version, 10) >= 17 ? "enterKeyHint" : "enterkeyhint"]: isEditable ? "next" : void 0,
  ...
  const valueStr = React32.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  React32.useEffect(() => {
...
var useFieldV6TextField = (params) => {
  const isRtl = useRtl();
  const focusTimeoutRef = React33.useRef();
  const selectionSyncTimeoutRef = React33.useRef();
  const {
    forwardedProps: {
      onFocus,
      onClick,
  ...
  const sections = React33.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  const interactions = React33.useMemo(() => ({
    syncSelectionToDOM: () => {
      if (!inputRef.current) {
        return;
      }
  ...
  const valueStr = React33.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React33.useEffect(() => {
  ...
  const inputMode = React33.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
...
var useField = (params) => {
  ...
  const sectionOrder = React34.useMemo(() => getSectionOrder(state.sections, isRtl && !enableAccessibleFieldDOMStructure), [state.sections, isRtl, enableAccessibleFieldDOMStructure]);
  const {
    returnedValue,
    interactions
  ...
  const inputError = React34.useMemo(() => {
    if (error !== void 0) {
      return error;
    }
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime10.jsxs)(React35.Fragment, {
...
var PickersSectionList = React36.forwardRef(function PickersSectionList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersSectionList"
  });
  ...
  React36.useImperativeHandle(sectionListRef, () => ({
    getRoot() {
  ...
  return (0, import_jsx_runtime11.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime11.jsx)(React36.Fragment, {
...
var PickersInputBase = React37.forwardRef(function PickersInputBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInputBase"
  });
...
var PickersOutlinedInput = React39.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersOutlinedInput"
  });
  ...
  return (0, import_jsx_runtime14.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime14.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime14.jsxs)(React39.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
var PickersFilledInput = React40.forwardRef(function PickersFilledInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersFilledInput"
  });
...
var PickersInput = React41.forwardRef(function PickersInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInput"
  });
...
var PickersTextField = React42.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
...
var DateField = React43.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
var useIsDateDisabled = ({
  ...
  const adapter = useLocalizationContext();
  return React44.useCallback((day) => validateDate({
    adapter,
    value: day,
    props: {
      shouldDisableDate,
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React45.useRef(createCalendarStateReducer(Boolean(reduceAnimations), disableSwitchToMonthOnDayFocus, utils)).current;
  ...
  const [calendarState, dispatch] = React45.useReducer(reducerFn, {
    isMonthSwitchingAnimating: false,
    focusedDay: referenceDate,
    currentMonth: utils.startOfMonth(referenceDate),
    slideDirection: "left"
  });
  const handleChangeMonth = React45.useCallback((payload) => {
    dispatch(_extends({
      type: "changeMonth"
    }, payload));
    if (onMonthChange) {
  ...
  const changeMonth = React45.useCallback((newDate) => {
  ...
  const onMonthSwitchingAnimationEnd = React45.useCallback(() => {
    dispatch({
...
var PickersDayRaw = React47.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
...
var PickersDay2 = React47.memo(PickersDayRaw);
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime21.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React48.cloneElement(element, {
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React49.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const outsideCurrentMonth = React49.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const isFirstVisibleCell = React49.useMemo(() => {
  ...
  const isLastVisibleCell = React49.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const [internalFocusedDay, setInternalFocusedDay] = React49.useState(() => focusedDay || now);
  ...
  const validSelectedDays = React49.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React49.useMemo(() => React49.createRef(), [transitionKey]);
  const focusableDay = React49.useMemo(() => {
  ...
  const weeksToDisplay = React49.useMemo(() => {
...
var PickersMonth = React50.memo(function PickersMonth2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersMonth"
  });
...
var MonthCalendar = React51.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React51.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedMonth = React51.useMemo(() => {
    if (value != null) {
      return utils.getMonth(value);
    }
    return null;
  }, [value, utils]);
  const [focusedMonth, setFocusedMonth] = React51.useState(() => selectedMonth || utils.getMonth(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "MonthCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isMonthDisabled = React51.useCallback((dateToValidate) => {
...
var PickersYear = React52.memo(function PickersYear2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersYear"
  });
...
var _excluded31 = ["autoFocus", "className", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var YearCalendar = React53.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React53.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React53.useMemo(() => {
    if (value != null) {
      return utils.getYear(value);
    }
    return null;
  }, [value, utils]);
  const [focusedYear, setFocusedYear] = React53.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React53.useCallback((dateToValidate) => {
  ...
  const scrollerRef = React53.useRef(null);
...
var PickersArrowSwitcher = React54.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
...
var PickersCalendarHeader = React56.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickersTranslations();
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
...
var DateCalendar = React57.forwardRef(function DateCalendar2(inProps, ref) {
  const utils = useUtils();
  const id = useId();
  ...
  const prevOpenViewRef = React57.useRef(view);
  React57.useEffect(() => {
  ...
  const selectedDays = React57.useMemo(() => [value], [value]);
...
var useMobilePicker = (_ref) => {
  ...
  const utils = useUtils();
  const fieldRef = React61.useRef(null);
  const labelId = useId();
  const isToolbarHidden = ((_a = innerSlotProps == null ? void 0 : innerSlotProps.toolbar) == null ? void 0 : _a.hidden) ?? false;
  const {
    open,
